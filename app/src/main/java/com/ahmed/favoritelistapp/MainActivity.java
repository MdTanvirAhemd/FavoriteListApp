package com.ahmed.favoritelistapp;
...
import com.ahmed.favoritelistapp.databinding.ActivityMainBinding;
...
//                Locale.Category category = new Locale.Category(categoryEditText.getText().toString(), new ArrayList<String>());
//                mCategoryFragment.giveCategoryToManager(category);
